...
option_list <- list(
  make_option(c("-d", "--directory"), type="character", default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_6/short-DEGs-2/",
  ...
  make_option(c("-g", "--genes"), type="character", default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_6/short-stringtie/gene_count_matrix.csv",
              help="count matrix file name"),
  make_option(c("-c", "--comparisons"), type="character", default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_6/comparisons.csv",
  ...
  make_option(c("-n", "--toolNumber"), type="integer", default = 3,
