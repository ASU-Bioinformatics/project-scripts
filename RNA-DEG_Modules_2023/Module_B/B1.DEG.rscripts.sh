...
do
  echo $i
  if [[ $i == "deseq2" ]]; then
    Rscript /data/gencore/shared_scripts/RNAseq/RNA-DEGs-Modular-240314-v1.0.1/Module_B/B2.deseq2.R \
      -d $directory -g $geneMatrix -c $comparisons

  elif [[ $i == "edger" ]]; then
    Rscript /data/gencore/shared_scripts/RNAseq/RNA-DEGs-Modular-240314-v1.0.1/Module_B/B3.edgeR.R \
      -d $directory -g $geneMatrix -c $comparisons

  elif [[ $i == "noiseq" ]]; then
    Rscript /data/gencore/shared_scripts/RNAseq/RNA-DEGs-Modular-240314-v1.0.1/Module_B/B4.noiseq.R \
      -d $directory -g $geneMatrix -c $comparisons
