...
METADATA="/data/gencore/analysis_projects/7232686_Ball_ITS/transplant/Metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/7232686_Ball_ITS/transplant/qiime2"
SAMPLING_DEPTH=1466 #typically, lowest feature count from samples, found in table.qzv
...
classifiers[it]="/data/biocore/qiime2_classifiers/qiime-2024.5/unite_ver10_99_s_all_04.04.2024-Q2-2024.5.qza"

#put all categorical columns here for unifrac plots by category
categories="Name Plot Experiment PlantType Replicate"

#numericals="Initial-Selenium-Concentration Initial-Sulfate-Concentration Initial-Nitrate-Concentration"
