...
METADATA="/data/gencore/analysis_projects/6914189_Marshall/metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/6914189_Marshall/qiime2"
SAMPLING_DEPTH=27336 #typically, lowest feature count from samples, found in table.qzv
...
categories="Replicate Location treatment Replicates Control"
