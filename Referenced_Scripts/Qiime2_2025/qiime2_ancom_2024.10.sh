...
mkdir gg-rel-table3-2024.10
qiime tools export \
--input-path rel-level3_table-2024.10-sol.qza \
--output-path gg-rel-table3-2024.10
#this step will probably produce a python error but it succeeds
cd gg-rel-table3-2024.10
biom convert -i feature-table.biom -o gg-rel-level3-table-2024.10.tsv --to-tsv
