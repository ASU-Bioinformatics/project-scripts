...
option_list <- list(
  make_option(c("-d", "--directory"), type="character",
              default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_5/short-human-DEGs-2",
              help="path to count matrix and template information"),
  make_option(c("-g", "--genes"), type="character",
              default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_5/short-stringtie/gene_count_matrix_human.csv",
              help="count matrix file name"),
  make_option(c("-c", "--comparisons"), type="character",
              default="/Volumes/Gencore/analysis_projects/5663018_Masmudur_RNA/project_5/comparisons.csv",
...
degenes.lists <- sapply(names(results.noiseq.list),
                        function (x) {
                          lists <- list("all.sig" = degenes(results.noiseq.list[[x]], q=0.99, M=NULL),
