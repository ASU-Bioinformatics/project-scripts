...
METADATA="/data/gencore/analysis_projects/6353838_Dulith_16S/Metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/6353838_Dulith_16S/qiime2_rerun"
SAMPLING_DEPTH=1440 #typically, lowest feature count from samples, found in table.qzv
...
categories="Material Column_age Column_location"

numericals="Initial_Cr_Conc Sulfate_conc Nitrate_Conc"
