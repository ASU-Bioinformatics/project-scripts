...
DIRECTORY="qiime2"
SAMPLING_DEPTH= # lowest feature count from table.qzv
MIN_DEPTH=100

#comment out a line to exclude a classifier, or add a new line to include a new classifier
declare -A classifiers
classifiers[sv]="qiime2_classifiers/qiime-2022.2/silva-138-99-515-806-nb-classifier.qza"
classifiers[gg]="qiime2_classifiers/qiime-2022.2/gg-13-8-99-515-806-nb-classifier.qza"

# the names may not be exactly what the qiime artifacts show
categories="BP_Lab_ID
            Type
            Gender
            Affected
            Birthdate
