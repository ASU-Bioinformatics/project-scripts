...
METADATA="/data/gencore/analysis_projects/7412225_Rocha_16s/metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/7412225_Rocha_16s/qiime2"
SAMPLING_DEPTH=604 #typically, lowest feature count from samples, found in table.qzv
...
categories="Gender Pellet Diet Slice-Orientation"
