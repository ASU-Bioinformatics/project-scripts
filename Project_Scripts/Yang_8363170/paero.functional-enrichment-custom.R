...
option_list <- list(
  make_option(c("-d", "--directory"), type="character", default="/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment",
              help="path to count matrix and template information"),
  make_option(c("-g", "--genes"), type="character", default="/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment/gene_count_matrix_idsonly.csv",
              help="count matrix file name"),
  make_option(c("-c", "--comparisons"), type="character", default="/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment/comparisons.csv",
  ...
  make_option(c("-f", "--functionToGene"), type="character", default = "/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment/go-to-gene.txt",
...
enricher(
  gene = deg.up.list$Treated_v_Untreated$ids,
  minGSSize = 3,
  pvalueCutoff = 0.5,
  pAdjustMethod = "BH",
  qvalueCutoff = 0.5,
