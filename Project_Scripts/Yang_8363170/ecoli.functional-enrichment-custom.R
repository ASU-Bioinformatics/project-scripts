...
option_list <- list(
  ...
  make_option(c("-g", "--genes"), type="character", default="/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment/gene_count_matrix.csv",
  ...
  make_option(c("-f", "--functionToGene"), type="character", default = "/Users/kawoodbu/Documents/TEMP_FOR_SOL/functional-enrichment/CFT073.goterms.txt",
