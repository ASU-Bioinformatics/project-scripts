...
METADATA="/data/gencore/analysis_projects/6726925_Ishani_16s/metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/6726925_Ishani_16s/fastq/qiime2"
SAMPLING_DEPTH=1655 #typically, lowest feature count from samples, found in table.qzv
...
categories="Column-ID-Location Selenium-Species"
