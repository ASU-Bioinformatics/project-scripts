...
METADATA="/data/gencore/analysis_projects/6666138_Penton_16s/Penton_Final_Metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/6666138_Penton_16s/fastq/qiime2"
SAMPLING_DEPTH=27104 #typically, lowest feature count from samples, found in table.qzv
...
categories="Time Treatment"

numericals="Depth Site"
