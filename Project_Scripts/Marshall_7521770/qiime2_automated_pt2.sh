...
source activate /data/biocore/programs/mamba-envs/qiime2-amplicon-2024.5/

##### Define Variables #####

METADATA="/data/gencore/analysis_projects/7521770_Marshall_16s/metadata-corrected.txt"
DIRECTORY="/data/gencore/analysis_projects/7521770_Marshall_16s/qiime2"
SAMPLING_DEPTH=22299 #typically, lowest feature count from samples, found in table.qzv
...
classifiers[sv]="/data/biocore/qiime2_classifiers/qiime-2024.5/silva-138-99-nb-classifier.qza" # full length silva; qiime2 notes that taxonomy may be unreliable
classifiers[gg]="/data/biocore/qiime2_classifiers/qiime-2024.5/2022.10.backbone.full-length.nb.sklearn-1.4.2.qza" #full length from updated greengenes
#classifiers[18]="/data/biocore/qiime2_classifiers/qiime-2024.5/silva-138-99-nb-classifier.qza" # full length silva; qiime2 notes that taxonomy may be unreliable
#classifiers[it]="/data/biocore/qiime2_classifiers/qiime-2024.5/unite_ver10_99_s_all_04.04.2024-Q2-2024.5.qza" # full-length ITS

#put all categorical columns here for unifrac plots by category
categories="Collected-Date Treatment-1 Treatment-2 Bin Treatment2-and-Date Bin-and-Date"

numericals="Date-Collected"
