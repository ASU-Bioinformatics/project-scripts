...
METADATA="/data/gencore/analysis_projects/6745932_Marshall_16s/metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/6745932_Marshall_16s/qiime2"
SAMPLING_DEPTH=20887 #typically, lowest feature count from samples, found in table.qzv
...
categories="Date Treatment-1 Treatment-2 Bin"
