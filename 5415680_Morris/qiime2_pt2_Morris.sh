...
METADATA="/data/gencore/analysis_projects/5415680_Morris_16S/metadata.txt"
DIRECTORY="/data/gencore/analysis_projects/5415680_Morris_16S/qiime2"
SAMPLING_DEPTH=105100 #typically, lowest feature count from samples, found in table.qzv
MIN_DEPTH=1000 #something lower, to get a good curve from min_depth to sampling_depth
