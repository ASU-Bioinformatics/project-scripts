...
DIRECTORY="/data/gencore/analysis_projects/6908615_Wilhelmi_16s/Filter_only/qiime2"
SAMPLING_DEPTH=261 #typically, lowest feature count from samples, found in table.qzv
...
categories="Treatment Replicate"
